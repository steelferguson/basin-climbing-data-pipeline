...
s3_path_capitan_temporary_passes = "capitan/temporary_passes.csv"
...
s3_path_customers_master = "customers/customers_master.csv"  # DEPRECATED — do not use for lookups. Use customer_master_v2.csv
s3_path_customers_master_v2 = "customers/customer_master_v2.csv"  # Primary customer table
...
# Firebase birthday parties
s3_path_birthday_parties = "firebase/birthday_parties.csv"
